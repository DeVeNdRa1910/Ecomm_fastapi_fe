...
export default function CookiePolicyPage() {
  ...
  const cookieData = data || {
    ...
    introduction: "This Cookie Policy explains how fastapi_comm uses cookies and similar technologies to recognize you when you visit our website.",
    sections: [],
    cookieTypes: [],
    contact: {
                        ...
                        >
                          <Card className="shadow-lg border-border h-full">
                            <CardContent className="p-6">
                              <h3 className="text-xl font-semibold mb-2">{cookieType.name}</h3>
